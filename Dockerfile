...
## Python: https://github.com/docker-library/python/blob/master/3.6/alpine/Dockerfile
...
ADD zkGenServers.py /usr/local/bin/zkGenServers.py
RUN pip install requests

ADD zoo.cfg.ctmpl /conf/zoo.cfg.ctmpl
